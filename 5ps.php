...
<body>  
    ...
    <div class="container-sm text-center ">
        <h5 class="card-title text-center" style="margin-top:3%">Realizar un programa que te permita reconocer un correo electrónico de HOTMAIL, GMAIL, YAHOO, y el resultado mostrar en una tabla identificando a cada uno.</h5>
        <br><br>
        <form action="resultados/5.php"method="POST">
                <div class="mb-3 row">
                    ...
                    <a href="http://localhost/paginaweb/" class="btn btn-outline-danger">Volver</a>    
                </div>                    
                </div>    
                </form>
    </div>
