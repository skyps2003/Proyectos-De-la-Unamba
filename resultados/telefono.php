...
<head>
    ...
    <title>Resultado de Numeros de Telefono Encontradas</title>
    ...
    <div class="container-fluid ">
        ...
        <div class="row py-4">
            ...
            <div class="col-lg-6 offset-md-3 bg-black py-4 text-center">
                    ...
                    if($total == 0){
                       echo '
                        <div class="alert alert-danger text-center" role="alert">
                            ...
                            <p>No se encontro ninguna Numeros de Telefono valida en el texto enviado.</p>
                            <hr>
                ...
                ?>
                <a href="http://localhost/paginaweb/telefono.php" class="btn btn-outline-success">Nueva Consulta</a>
            </div>
        </div>
    </div>
</body>
