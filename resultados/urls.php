<?php
    ...
    $texto = $_POST['texto'];
    $exp_reg = "/\b(w{3}\.|[a-z\:]{5,6}\/\/)?[a-zA-Z0-9\._-]*\.[a-z]{2,5}\b/i";
    ...
    <div class="container-fluid">
        ...
        <div class="row py-4">
            ...
            <div class="col-lg-6 offset-md-3 bg-black py-4 text-center">
                    ...
                    if($total == 0){
                       echo '
                        <div class="alert alert-danger text-center" role="alert">
                            ...
                            <p>No se encontro ninguna Url valida en el texto enviado.</p>
                            <hr>
                ...
                <a href="http://localhost/paginaweb/url.php" class="btn btn-outline-success">Nueva Consulta</a>
