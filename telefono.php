...
<head>
    ...
    <title>Validador de Telefonos </title>
...
<body>  
    ...
    <div class="row py-4">
            <h1 class="display-6 text-center">Buscar numero de Telefono en un texto </h1>
            <div class="col-lg-6 offset-md-3  py-4">
                <form action="resultados/telefono.php"method="POST">
                <div class="mb-3 row">
                    ...
                    <button type="submit" class="btn btn-outline-success">Enviar Texto</button>
                    </div>                    
                </div>    
                </form>
            </div>
