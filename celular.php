...
<head>
    ...
    <title>Validador de Celulares </title>
...
<body>  
    ...
    <div class="row py-4">
            <h1 class="display-6 text-center">Buscar numero de Celular en un texto </h1>
            <div class="col-lg-6 offset-md-3  py-4">
                <form action="resultados/celular.php"method="POST">
                <div class="mb-3 row">
