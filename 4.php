...
<div class="row">
    <?php include_once 'secciones/menu.php';?>
        ...
        <div class="row py-4">
            <h1 class="display-6  text-center">TARJETAS</h1>
            <div class="col-lg-6 offset-md-3  py-4">
            <form id="enviar_datos">
					<div class="mb-3 row">
						
						<label class="col-sm-3 text-white py-1 "><b>Numero de Tarjeta  </b></label>
						<div class="col-sm-9 py-1">
                        <input  class="form-control bg-black text-white" type="text" id="nroTar" name="nroTar"  required>
                        </div>
						</div>
                        <label class="col-sm-3 col-form-label text-white py-1"><b>Fecha de Vencimiento</b></label>
						<div class="col-sm-9 py-1">
							<input class="form-control bg-black text-white" type="text" name="venTar" placeholder="12/24" pattern="(((0[1-9]|1[0-2])/2[4-9])|((0[1-9]|1[0-2])/[3-9][0-9]))"   required />
						</div>
						<label class="col-sm-3 col-form-label text-white py-1"><b>Código de Seguridad </b></label>
						<div class="col-sm-9 py-1">
							<input class="form-control bg-black text-white" type="text" name="cvvTar" pattern="[1-9][0-9]{2}" required/>
						</div> 
