...
$estudiante = "SELECT m.idMat, c.nomCur, a.codAlu, m.estMat FROM matricula m
                JOIN curso c ON c.idCur = m.idCur
                JOIN alumno a ON a.idAlu = m.idAlu";
...
<div class="row py-4">
            <h1 class="display-6 text-white text-center">Tabla de Matricula</h1>
