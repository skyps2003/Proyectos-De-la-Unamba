...
<head>
    ...
    <title>Base de Datos - Matricula</title>
...
<body>
    ...
    <?php include_once 'secciones/menu.php';?>
        ...
        <div class="row py-4">
            <h1 class="display-6  text-center">Matricula</h1>
            <div class="col-lg-6 offset-md-3  py-4">
            <form id="enviar_datos">
                    
					<div class="mb-3 row">
						
						<label class="col-sm-3 text-white py-1 "><b>ID de Curso </b></label>
						<div class="col-sm-9 py-1">
                        <select class="form-select bg-black text-white" name="curso">
                                    
                                    <?php
                                        $sql="SELECT *FROM curso ORDER BY idCur ASC";
                        ...
                        <label class="col-sm-3 text-white py-1 "><b>Identificacion del Alumno </b></label>
						<div class="col-sm-9 py-1">         
                        <select class="form-select bg-black text-white" name="alumno">
               
                            <?php
                                $sql="SELECT *FROM alumno ";
                                $query=$conector->query($sql);
                                while($row=$query->fetch_array()){
                                    echo '<option value="'.$row['idAlu'].'">'.$row['codAlu'].'</option>';
                                }
                            ?>
                            </select>
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-3   text-white  py-1"><b>Estado de la matricula </b></label>
                            <div class="col-sm-9 py-1">
                            <select class="form-select bg-black text-white" name="matricula">
                                        <option value="Activo">Activo</option>
                                        <option value="Suspendido">Suspendido</option>
                                        <option value="Finalizado">Finalizado</option>
                                        <option value="Prematrícula">Prematrícula</option>
                            </select>
                            </div>
