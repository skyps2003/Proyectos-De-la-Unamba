...
<body>  
    ...
    <div class="row py-4">
            <h1 class="display-6 text-center">Buscar DNI en un texto </h1>
            <div class="col-lg-6 offset-md-3  py-4">
                <form action="resultados/dni.php"method="POST">
                <div class="mb-3 row">
                    
                    <div class="col-sm-20">
                        <input name="texto" placeholder="Ingrese el numero de DNI " class="form-control bg-black text-white">
                    </div>
